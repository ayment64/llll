...
class LoginErrorDisplay extends StatefulWidget {
  ...
  @override
  _LoginErrorDisplayState createState() => _LoginErrorDisplayState();
}

class _LoginErrorDisplayState extends State<LoginErrorDisplay> {
  String username;
  String password;
  @override
        ...
        child: ListView(
          children: <Widget>[
            ...
            Container(
              ...
              child: Center(child: Text('Username or Password is incorrect',style: TextStyle(color: Colors.red),)),
            ),
            Padding(
